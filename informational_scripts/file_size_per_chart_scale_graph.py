...
Band4_5m_grid_nodes =  ((18*1852)/5 )*((18*1852)/5) #converts nautical miles to meters, divides by grid resolution and mutiplies by itself to get total nodes
Band5_5m_grid_nodes = ((4.5*1852)/5)*((4.5*1856)/5) #converts nautical miles to meters, divides by grid resolution and mutiplies by itself to get total nodes
