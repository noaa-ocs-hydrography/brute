...
import fuse.raw_read.usace.extract_ehydro_meta_class_CESAJ as e_meta
...
def retrieve_meta_for_Ehydro_notable(highresfolder, ehydrofolder, metafile, df_export_to_csv):
    g1 = ehydro_subset_only_ifnotfull_restoo(highresfolder, ehydrofolder)
    merged_meta = {}
    merge2 = {}
    nn = pd.DataFrame()
    ...
    for basename in g1:
        ...
        if os.path.isfile(xmlfilename):        
            ...
            meta_xml = {}
        meta = e_t.parse_ehydro_xyz(f, meta_source = 'xyz', version='CESAJ', default_meta = '')#parse_ehydro_xyz(infilename, meta_source = 'xyz', version='CEMVN', default_meta = '')#eH_p.parse_ehydro_xyz(f)
...
def test_cesam_ccom_defaultnames():
    ...
    merged_meta1, merged_dataframe = retrieve_meta_for_Ehydro_notable(highresfolder, ehydrofolder, metafile, df_export_to_csv)
