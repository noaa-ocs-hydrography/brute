...
class Form ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		bSizer3.SetMinSize( wx.Size( 50,-1 ) )
		...
		self.text_region = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_CENTER|wx.TE_READONLY )
		bSizer3.Add( self.text_region, 1, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		self.text_output = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_DONTWRAP|wx.TE_MULTILINE|wx.TE_READONLY )
