import psycopg2
import pickle
URL_FILENAME = r"D:\credentials\postgres_hostname.txt"
CREDENTIALS_FILENAME = r"D:\credentials\postgres_scripting.txt"

url = 'OCS-VS-NBS01:5434'
...
connection = connect_with_retries(database='metadata', user='scripting', password='gogogo!', host='OCS-VS-NBS01', port='5434')
