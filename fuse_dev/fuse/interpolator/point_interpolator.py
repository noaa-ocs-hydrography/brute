...
class point_interpolator:
    ...
    def __init__(self, window_scale: float = 1.1):
        """
    ...
    def _getShpRast(self, file: str, to_proj: str, to_gt: tuple, to_res: float, to_y: int, to_x: int,
    ...
    def _get_shape_mask(self, grid: gdal.Dataset, shapefile: str, resolution: float):
