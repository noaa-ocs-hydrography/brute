...
try:
    import fuse.raw_read.usace.parse_usace_pickle as p_usace_pickle
except:
    try:
        from . import parse_usace_pickle as p_usace_pickle
    except:
        print('importing fuse.raw_read.usace.parse_usace_picklel as p_usace_pickle did not work') 
##-----------------------------------------------------------------------------
...
class Extract_Txt(object):
    ...
    def parse_ehydro_xyz(self, infilename, meta_source = 'xyz', version= 'CESAJ', default_meta = ''):#need to change version to None
        """
