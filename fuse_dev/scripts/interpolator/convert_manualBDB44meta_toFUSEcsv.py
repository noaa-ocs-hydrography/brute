...
def usace_convert_manualfile():
    ...
    csvfilename = r"N:\Data\metadata\NewYork\Mapping_Glen_Ehydro_Meta_NYFUSE1.csv"
    file1=inputtab
...
def fromNCEI_convert_manualfile():
    ...
    test=r"N:\New_Directory_1\GulfCoast\Mississippi\Metadata\NCEI_mapping_Template_checking2c.csv"
    #test2 = r"N:\Data\metadata\NewYork\BathyPointStore.txt"
    csvfilename = test
    csvfilename2 =r"N:\New_Directory_1\GulfCoast\Mississippi\Metadata\Mapping_NCEI_Meta_templateCheck1.csv"#r"N:\Individual\Juliet\TestLoad\Mapping_NCEI_fields_Meta2.csv"
