...
class Form(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Interpolation Tool", pos=wx.DefaultPosition,
                          size=wx.Size(500, 625), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.menu_quit = wx.MenuItem(self.menu_file, wx.ID_ANY, "Quit\tCTRL+Q", wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.picker_bag = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file",
                                            u"BAG Files (*.bag)|*.bag", wx.DefaultPosition, wx.DefaultSize,
        ...
        self.label_des = wx.StaticText(self, wx.ID_ANY, u"Destination (Optional):", wx.DefaultPosition, wx.DefaultSize,
                                       0)
        self.label_des.Wrap(-1)

        opts_form.Add(self.label_des, 0, wx.ALL | wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)

        self.picker_des = wx.DirPickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition,
                                           wx.DefaultSize, wx.DIRP_DEFAULT_STYLE)
        opts_form.Add(self.picker_des, 1, wx.ALL | wx.EXPAND, 5)

        self.label_catzoc = wx.StaticText(self, wx.ID_ANY, u"Interpolated Uncertainty CATZOC Score:",
        ...
        self.label_depth = wx.StaticText(self, wx.ID_ANY, u"Depth Threshold for Interpolated Data:", wx.DefaultPosition,
        ...
        self.picker_depth = wx.SpinCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
        ...
        self.radio_data = wx.RadioBox(self, wx.ID_ANY, u"Output Data", wx.DefaultPosition, wx.DefaultSize,
                                      radio_dataChoices, 2, wx.RA_SPECIFY_COLS)
...
class Done(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"Interpolation Tool", pos=wx.DefaultPosition,
                           size=wx.Size(350, 150), style=wx.DEFAULT_DIALOG_STYLE)

        self.SetSizeHints(wx.DefaultSize, wx.DefaultSize)

        container_dialog = wx.BoxSizer(wx.VERTICAL)

        self.label_done = wx.StaticText(self, wx.ID_ANY, u"Done!", wx.Point(-1, -1), wx.DefaultSize,
