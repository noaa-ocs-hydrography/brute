...
class Form(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.label_north = wx.StaticText(box_latlong.GetStaticBox(), wx.ID_ANY, u"North:", wx.DefaultPosition,
                                         wx.DefaultSize, 0)
        self.label_north.Wrap(-1)

        fgSizer2.Add(self.label_north, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 5)

        self.text_north = wx.TextCtrl(box_latlong.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                      wx.DefaultSize, 0)
        fgSizer2.Add(self.text_north, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.lebel_west = wx.StaticText(box_latlong.GetStaticBox(), wx.ID_ANY, u"West:", wx.DefaultPosition,
                                        wx.DefaultSize, 0)
        self.lebel_west.Wrap(-1)

        fgSizer2.Add(self.lebel_west, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 5)

        self.text_west = wx.TextCtrl(box_latlong.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                     wx.DefaultSize, 0)
        fgSizer2.Add(self.text_west, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.label_south = wx.StaticText(box_latlong.GetStaticBox(), wx.ID_ANY, u"South:", wx.DefaultPosition,
                                         wx.DefaultSize, 0)
        self.label_south.Wrap(-1)

        fgSizer2.Add(self.label_south, 0, wx.ALL | wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)

        self.text_south = wx.TextCtrl(box_latlong.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                      wx.DefaultSize, 0)
        fgSizer2.Add(self.text_south, 1, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.label_east = wx.StaticText(box_latlong.GetStaticBox(), wx.ID_ANY, u"East:", wx.DefaultPosition,
                                        wx.DefaultSize, 0)
        self.label_east.Wrap(-1)

        fgSizer2.Add(self.label_east, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 5)

        self.text_east = wx.TextCtrl(box_latlong.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                     wx.DefaultSize, 0)
