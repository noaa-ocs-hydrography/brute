...
class Form ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"NCEI Bag Finder", pos = wx.DefaultPosition, size = wx.Size( 300,475 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.menu_about = wx.MenuItem( self.menu_file, wx.ID_ANY, u"About"+ u"\t" + u"CTRL+H", wx.EmptyString, wx.ITEM_NORMAL )
		...
		self.radio_query = wx.RadioBox( self, wx.ID_ANY, u"Query Type", wx.DefaultPosition, wx.DefaultSize, radio_queryChoices, 2, wx.RA_SPECIFY_COLS )
		self.radio_query.SetSelection( 0 )
		box_container.Add( self.radio_query, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 5 )

		self.label_about = wx.StaticText( self, wx.ID_ANY, u"Use 'CTRL+H' or 'File -> About' for more information on the attribute fields returned by either Query Type", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_LEFT )
